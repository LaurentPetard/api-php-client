...
$auth = new \Akeneo\Authentication(
    '1_2x3blk5nt2kgc8840kgk8cc0804kwow88cswo84gc40wc0g0cw',
    'giz5ttpdzlwgcso8og8o44c04gc0swsksgkcwk848ccs48w40',
    'admin',
    'admin'
);

$clientBuilder = new \Akeneo\Client\ClientBuilder();
$client = $clientBuilder->build('http://akeneo-pim.local/', $auth);
